...
extension Resolver: ResolverRegistering {
  public static func registerAllServices() {
    ...
    // register application components
      ...
      register { FirestorePostRepository() as PostRepository }.scope(.application)
      register { FirestoreMessageRepository() as MessageRepository }.scope(.application)
      register { LocationService() as LocationService }.scope(.application)
  }
}
